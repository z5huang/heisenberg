# Time-stamp: <2018-01-19 09:42:56 zshuang>
# S=1 Heisenberg, variational sol
...
def full_wf(uproj, nsites):
    up = uproj.flatten()
    res = np.zeros(3**nsites, dtype=up.dtype)
...
class Hinter_var(Hvar):
    ...
    def __init__(self, nsites = 12, u_aklt = None, h1 = None, h2 = None):
